...
public void draw1(Object referenceObject, String color, Shape shape)
    {
    ...
    public void setForegroundColor(String colorString)
    {
        if(colorString.equals("red")) {
            ...
            graphic.setColor(new Color(90, 33, 2));
        }
        else if(colorString.equals("cafesito")) {
            graphic.setColor(new Color(250, 221, 157));
        }
        else {
            graphic.setColor(Color.black);
        }
    ...
    private class CanvasPane extends JPanel
    {
        ...
        public void erase1(Object referenceObject)
    {
        objects.remove(referenceObject);   // just in case it was already there
